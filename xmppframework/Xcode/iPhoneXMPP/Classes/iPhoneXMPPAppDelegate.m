...
//	[xmppStream setMyJID:[XMPPJID jidWithString:@"username@gmail.com/iPhoneTest"]];
//	password = @"pwd";
...
//	[xmppStream setHostName:@"zhang-johnnys-imac.local"];
	[xmppStream setHostName:@"211.136.105.12"];
	[xmppStream setHostPort:5222];
